...
const Links = ({ loadedState }: Props) => {
  ...
  return (
    <ul
      className={`${loaded ? "animate-LinksMotion" : ""} p-4 flex flex-row justify-center fixed -bottom-10 left-1/2 transform -translate-x-1/2 w-screen bg-theme-off-white/60 dark:bg-theme-blue/60 backdrop-blur-md`}
    >
