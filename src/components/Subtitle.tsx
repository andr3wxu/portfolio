  ...
  return (
    ...
    >
      <p className={`p-5 leading-5`}>
        Currently <span className={`font-semibold`}>SWE</span> at{" "}
        <a
          href={"https://www.sectorgrowth.ca"}
          target="_blank"
        ...
        >
          <span className={`font-mono font-light`}>[</span>Sector Growth
